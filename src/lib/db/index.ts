...
import { admins, guests, settings, usageLogs, type Guest, type Admin, type Setting, type UsageLog } from './schema';

// 重新导出类型
export type { Admin, Guest, Setting, UsageLog, DiscountType, GuestStatus } from './schema';
